...
(5, 'Carrot Cupcake', '160/box', 'carrotcupcake.png', 'A delightful box of five, a classic favorite, featuring a moist and fluffy carrot-infused base with a hint of warm spices, crowned with a swirl of velvety cream cheese frosting. Perfect for an on-the-go treat!', 'Dairy, Eggs, Wheat, Nuts', 'Chilled 3-5 days');
